...
int ll_len(LinkedList* this); //devuelve el tamaño de la lista. Lo necesito porque como es una lista dinamica el tamaño va variando
...
int ll_clear(LinkedList* this); //borra los elementos de la lista, la deja en tamaño 0, como si recien la hubiese creado
